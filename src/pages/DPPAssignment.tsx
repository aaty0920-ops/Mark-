              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`p-2 rounded-full transition-colors ${bookmarked[q.id] ?"text-yellow-500 bg-yellow-500/10" :"text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white dark:text-white hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800"}`}
                  >
                    <Bookmark
                      size={16}
              ...
              {isAnswered && (
                <div className="mt-6">
                  <button
                    ...
                    className="w-full py-3 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-900/10 dark:border-white/10 rounded-xl font-bold hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-700 transition-colors"
                  >
