...
const FormulaChapter = () => {
  ...
  const chapterData = useMemo(() => {
    const data = JSON.parse(JSON.stringify(formulasData[subjectKey]?.chapters[chapterKey] || { topics: {} }));
    const customFormulas = customFormulasDB.getCustomFormulas().filter(f => f.subjectKey === subjectKey && f.chapterKey === chapterKey);
