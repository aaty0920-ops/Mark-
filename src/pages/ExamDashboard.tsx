...
export default function ExamDashboard() {
  ...
  const currentChapters = useMemo(() => {
    ...
    const subjectData = pyqData[pyqYear]?.[activeTab] || {
      solved: 0,
      total: 0,
    };
  ...
  const renderDashboard = () => {
    ...
    availableSubjects.forEach((subject) => {
      const data = pyqData[pyqYear]?.[subject as string] || {
        solved: 0,
        total: 0,
      };
      ...
      <div className="space-y-6 pb-24">
        ...
        <div className="bg-gradient-to-br from-slate-100/90 to-slate-200/90 dark:from-slate-800/90 dark:to-slate-900/90 backdrop-blur-xl p-7 rounded-[2.5rem] border border-slate-900/10 dark:border-white/10 shadow-2xl relative overflow-hidden">
                      ...
                      <button
                        ...
                        className={`w-full text-left px-5 py-3 text-sm font-bold transition-all ${
                          pyqYear === year
                            ...
                            :"text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 border-l-2 border-transparent"
                        }`}
                      >
                        {year}
                      </button>
          ...
          <div className="mb-8 relative z-10">
            ...
            <div className="h-3 bg-black/40 rounded-full overflow-hidden border border-slate-900/5 dark:border-white/5 shadow-inner">
              ...
              >
                <div className="absolute inset-0 bg-white/2 dark:bg-slate-900/20 w-full animate-[shimmer_2s_infinite]" />
              </motion.div>
            </div>
          </div>
              ...
              return (
                <div key={subject} className="space-y-2.5">
                  <div className="flex justify-between items-center text-sm font-bold">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-slate-900 dark:text-white bg-white/1 dark:bg-slate-900/10 px-2 py-0.5 rounded-md text-xs border border-slate-900/5 dark:border-white/5">
                        {progress.solved}{""}
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          >
            ...
            <span className="font-bold text-sm text-slate-600 dark:text-slate-300 group-hover:text-slate-900 dark:hover:text-white dark:text-white transition-colors">
              Analysis
            </span>
          </button>
          <button
              ...
              <div className="flex items-start justify-between gap-4 w-full">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span
                      className={`flex items-center gap-1 text-xs font-bold px-2 py-1 rounded-md bg-opacity-10 ${chapter.trend.up ?"text-emerald-400 bg-emerald-500/10 border border-emerald-500/20" :"text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700"}`}
                    >
                      {chapter.trend.year}: {chapter.trend.count} Qs{""}
                      {chapter.trend.up ? (
                        <ArrowUpDown
                          size={10}
                ...
                <div className="flex items-center justify-center p-3.5 rounded-xl bg-white/5 dark:bg-slate-900/50 border border-slate-200/50 dark:border-slate-700/50 group-hover:bg-brand group-hover:border-brand transition-all text-slate-500 dark:text-slate-400 group-hover:text-slate-900 dark:hover:text-white dark:text-white shadow-inner">
  ...
  const renderChapterDetail = () => (
    <div className="space-y-6 pb-24">
      <header className="flex items-center gap-4 mb-6 sticky top-0 bg-white/9 dark:bg-slate-900/90 backdrop-blur-xl z-40 py-4 border-b border-slate-900/5 dark:border-white/5 shadow-sm px-2">
        <button
          onClick={() => setView("dashboard")}
          className="p-2.5 hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 rounded-full transition-colors flex items-center justify-center border border-transparent hover:border-slate-900/5 dark:hover:border-white/5"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-white/1 dark:bg-slate-900/10 rounded-full blur-2xl group-hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors" />
          <Target
            size={32}
        ...
        >
          <div className="absolute top-0 left-0 w-32 h-32 bg-white/5 dark:bg-slate-900/5 rounded-full blur-2xl group-hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors" />
          <LayoutGrid
            size={32}
            className="text-slate-500 dark:text-slate-400 group-hover:text-slate-900 dark:hover:text-white dark:text-white transition-colors relative z-10"
          />
          <div className="flex flex-col items-center relative z-10">
            <span className="text-lg tracking-wide group-hover:text-slate-900 dark:hover:text-white dark:text-white text-slate-700 dark:text-slate-200 transition-colors">
              Topic Wise PYQs
            </span>
  ...
  const DashboardBottomNav = () => (
    <div className="fixed bottom-0 left-0 right-0 bg-white/9 dark:bg-slate-900/95 backdrop-blur-lg border-t border-slate-900/5 dark:border-white/5 pb-safe z-50">
  ...
  const renderAllQuestions = () => {
    ...
    if (isTopicOrAll) {
      if (selectedTopic) {
        const topicQsCount =
          selectedTopic ==="Units"
            ? Math.floor(activeChapter.totalQs * 0.3)
            : Math.floor(activeChapter.totalQs * 0.7);
        return (
          <div className="space-y-4 pb-24">
            <div className="space-y-6">
              <header className="flex items-center justify-between gap-4 mb-6">
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className="p-2 -ml-2 hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 rounded-full transition-colors text-slate-500 dark:text-slate-400"
                  >
                    <ArrowLeft size={24} />
                  </button>
                  <div>
              ...
              {(() => {
                const mockQuestions = Array.from({
                  length: Math.min(10, topicQsCount),
                }).map((_, i) => {
                ...
                let filteredQuestions = mockQuestions.filter((q) => {
                  ...
                  if (
                    pyqDifficulty.length > 0 &&
                    !pyqDifficulty.includes(q.difficulty)
                  )
                    return false;
                  if (
                    pyqQuestionType.length > 0 &&
                    !pyqQuestionType.includes(q.type)
                  )
                    return false;
                  if (
                    pyqEvaluationStatus.length > 0 &&
                    !pyqEvaluationStatus.includes(q.status)
                  )
                    return false;
                  if (pyqYears.length > 0 && !pyqYears.includes(q.year))
                    return false;
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <button
                                  ...
                                  className={`p-1.5 rounded-lg transition-colors ${isBookmarked ?"bg-blue-500/20 text-blue-500" :"bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white dark:text-white"}`}
                                >
                                  <Bookmark
                                    size={16}
                                    className={
                            ...
                            <p className="text-sm text-slate-700 dark:text-slate-200 leading-relaxed">
                              ...
                              plane of inclination θ. The inclined plane is
                              accelerated horizontally so that the block does
                              not slip. What is the acceleration?
                            </p>
                          </div>
                        );
                      })
        ...
        <div className="space-y-4 pb-24">
          ...
          <div className="flex gap-3 overflow-x-auto no-scrollbar mb-6">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full border text-sm font-medium whitespace-nowrap transition-colors ${hideOutOfSyllabus ?"border-brand bg-brand/10 text-brand" :"border-slate-900/10 dark:border-white/10 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800"}`}
            >
              As per syllabus
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-full border text-sm font-medium whitespace-nowrap transition-colors ${showOnlyOutOfSyllabus ?"border-brand bg-brand/10 text-brand" :"border-slate-900/10 dark:border-white/10 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800"}`}
            >
              Removed
            </button>
            <button className="px-4 py-2 rounded-full border border-slate-900/10 dark:border-white/10 text-slate-600 dark:text-slate-300 text-sm font-medium whitespace-nowrap hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800">
              Reduced
            </button>
          </div>
          ...
          {activeFilter ==="Topic Wise" ? (
              ...
              >
                <div>
                  ...
                  <div className="text-sm text-slate-500 dark:text-slate-400">
                    {Math.floor(activeChapter.totalQs * 0.3)} Questions
                  </div>
                </div>
                <ChevronRight
                  size={20}
            ...
            <div className="space-y-6">
              {Array.from({ length: Math.min(10, questionCount) }).map(
                (_, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-sm text-slate-700 dark:text-slate-200 leading-relaxed">
                        A block of mass m is placed on a smooth inclined plane
                        of inclination θ. The inclined plane is accelerated
                        horizontally so that the block does not slip. What is
                        the acceleration?
                      </p>
                    </div>
                  );
          ...
          {Array.from({ length: Math.min(10, questionCount) }).map((_, i) => {
            ...
            return (
              <div
                ...
                onClick={() =>
                  navigate("/app/practice", {
                    state: { questionIndex: i, source:"chapter-wise-pyq" },
                  })
                }
              >
                <div className="flex items-center justify-between mb-4">
                ...
                <p className="text-sm text-slate-700 dark:text-slate-200 leading-relaxed">
                  ...
                  inclination θ. The inclined plane is accelerated horizontally
                  so that the block does not slip. What is the acceleration?
                </p>
              </div>
            );
          })}
  ...
  const renderBookmarks = () => {
    const bookmarkedIndices = Object.keys(bookmarkedQs)
      .filter((key) => bookmarkedQs[Number(key)])
      .map(Number);
            ...
            {bookmarkedIndices.map((i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm text-slate-700 dark:text-slate-200 leading-relaxed">
                    A block of mass m is placed on a smooth inclined plane of
                    inclination θ. The inclined plane is accelerated
                    horizontally so that the block does not slip. What is the
                    acceleration?
                  </p>
                </div>
              );
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 text-slate-900 dark:text-white">
      {view ==="dashboard" && (
        <>
          <header className="px-6 pt-10 pb-6 sticky top-0 bg-white/9 dark:bg-slate-900/90 backdrop-blur-xl z-40 border-b border-slate-900/5 dark:border-white/5 shadow-sm">
            <div className="flex items-center justify-between gap-4 mb-6">
              <div className="flex items-center gap-4">
                <button
                  onClick={() => navigate("/app")}
                  className="p-2.5 -ml-2 hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 rounded-full transition-colors flex items-center justify-center border border-transparent hover:border-slate-900/5 dark:hover:border-white/5"
                >
                  <ArrowLeft
                    size={24}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/9 dark:bg-slate-900/90 backdrop-blur-lg border-t border-slate-900/5 dark:border-white/5 px-6 py-4 flex justify-between items-center z-50">
        <button
          onClick={() =>
            ...
            >
              ...
              <div className="space-y-2">
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl font-bold transition-colors ${selectedClass === null ?"bg-brand/20 text-brand" :"hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-600 dark:text-slate-300"}`}
                >
                  All Classes
                </button>
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl font-bold transition-colors ${selectedClass ==="11th" ?"bg-brand/20 text-brand" :"hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-600 dark:text-slate-300"}`}
                >
                  Class 11th
                </button>
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl font-bold transition-colors ${selectedClass ==="12th" ?"bg-brand/20 text-brand" :"hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-600 dark:text-slate-300"}`}
                >
                  Class 12th
                </button>
              </div>
            ...
            >
              ...
              <div className="space-y-2 overflow-y-auto pr-2">
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl font-bold transition-colors ${selectedUnit === null ?"bg-brand/20 text-brand" :"hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-600 dark:text-slate-300"}`}
                >
                  All Units
                </button>
                {[1, 2, 3, 4, 5].map((unitNum) => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-xl font-bold transition-colors ${selectedUnit === `Unit ${unitNum}` ?"bg-brand/20 text-brand" :"hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-600 dark:text-slate-300"}`}
                  >
                    Unit {unitNum}
                  </button>
                ))}
            ...
            >
              ...
              <div className="space-y-2">
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl font-bold transition-colors ${sortOrder ==="default" ?"bg-brand/20 text-brand" :"hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-600 dark:text-slate-300"}`}
                >
                  Default Order
                </button>
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl font-bold transition-colors ${sortOrder ==="name-asc" ?"bg-brand/20 text-brand" :"hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-600 dark:text-slate-300"}`}
                >
                  Name (A-Z)
                </button>
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl font-bold transition-colors ${sortOrder ==="name-desc" ?"bg-brand/20 text-brand" :"hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-600 dark:text-slate-300"}`}
                >
                  Name (Z-A)
                </button>
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl font-bold transition-colors ${sortOrder ==="qs-high" ?"bg-brand/20 text-brand" :"hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-600 dark:text-slate-300"}`}
                >
                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl font-bold transition-colors ${sortOrder ==="qs-low" ?"bg-brand/20 text-brand" :"hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 text-slate-600 dark:text-slate-300"}`}
                >
          ...
          >
            ...
            >
                      ...
                      <button
                        ...
                        className={`flex flex-col items-center justify-center py-4 gap-2 transition-colors relative ${
                          isActive
                            ...
                            :"text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 dark:bg-slate-800"
                        }`}
                      >
                        {isActive && (
                ...
                <div className="flex-1 bg-white dark:bg-slate-900 overflow-y-auto p-4 space-y-6">
                            ...
                            <button
                              ...
                              className={`p-3 rounded-xl border flex flex-col items-center justify-center gap-2 transition-colors ${
                                isSelected
                                  ...
                                  :"bg-white dark:bg-slate-900 border-slate-900/5 dark:border-white/5 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 dark:bg-slate-800"
                              }`}
                            >
                  ...
                  {activePyqFilterTab ==="Years" && (
                    <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-4 border border-slate-900/5 dark:border-white/5">
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg border border-slate-900/10 dark:border-white/10 text-sm text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors"
                          >
                            Last Year
                          </button>
                          <button
                      ...
                      <div className="flex flex-col gap-4">
                        {["JEE Main 2026","JEE Main 2025","JEE Main 2024","JEE Main 2023","JEE Main 2022","JEE Main 2021",
                        ].map((year) => (
                          <label
                            key={year}
              ...
              <div className="flex gap-3 p-4 border-t border-slate-900/10 dark:border-white/10 bg-slate-50 dark:bg-slate-800">
                <button
                  onClick={() => setShowPyqFilterModal(false)}
                  className="flex-1 py-3.5 bg-transparent border border-slate-900/20 dark:border-white/20 text-slate-900 dark:text-white rounded-xl font-bold hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors"
                >
                  Cancel
                </button>
                <button
