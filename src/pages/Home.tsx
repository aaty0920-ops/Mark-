...
const Home = () => {
  ...
  const progressPercentage = Math.min(
    100,
    Math.max(0, (currentQs / dailyGoal) * 100),
  );
              ...
              {isEditingGoal ? (
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <button
                    ...
                    className="bg-brand text-white px-3 py-1 rounded-lg text-sm font-bold shadow-md shadow-brand/20"
                  >
                    Save
                  </button>
                  <button
              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-sm shadow-xl transition-all duration-500 ${isActive ?"bg-brand text-slate-900 dark:text-white border-2 border-[#0F172A] shadow-brand/30 scale-110" :"bg-slate-50 dark:bg-slate-800 border-2 border-slate-600/50 text-slate-500 dark:text-slate-400"}`}
                  >
                    {step.icon}
                  </motion.div>
                </div>
            ...
            <div className="flex items-center gap-3">
              {tasks.some((t) => t.completed) && (
                <button
                  ...
                  className="text-xs font-bold text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white dark:text-white transition-colors uppercase tracking-wider"
                >
                  Clear Completed
                </button>
              )}
              ...
              <motion.div
                ...
                className={`p-4 rounded-xl border flex items-center justify-between cursor-pointer transition-all group ${
                  task.completed
                    ...
                    :"bg-slate-50/50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 dark:bg-slate-800 hover:border-slate-600 shadow-sm"
                }`}
              >
            ...
            <div className="grid grid-rows-2 grid-flow-col gap-4">
              {exams.map((exam, i) => {
                ...
                return (
                  ...
                  >
                    <div className="absolute -right-4 -bottom-4 w-16 h-16 bg-white/5 dark:bg-slate-900/5 rounded-full blur-xl group-hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors" />
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center shadow-inner ${exam.bg} ${exam.color}`}
                    >
                      <BookOpen size={20} />
                    </div>
                    <span className="text-sm font-bold leading-tight relative z-10 text-slate-700 dark:text-slate-200 group-hover:text-slate-900 dark:hover:text-white dark:text-white">
                      {exam.name}
                    </span>
                  </motion.div>
                );
                  ...
                  <div className="pr-4 tracking-wide w-full">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex -space-x-2">
                        <img
                          src="https://picsum.photos/seed/p1/30/30"
                          className="w-5 h-5 rounded-full border-2 border-slate-100 dark:border-slate-800"
                          alt="user"
                          referrerPolicy="no-referrer"
                        />
                        <img
                          src="https://picsum.photos/seed/p2/30/30"
                          className="w-5 h-5 rounded-full border-2 border-slate-100 dark:border-slate-800"
                          alt="user"
                          referrerPolicy="no-referrer"
                        />
                ...
                <div className="relative z-10 flex items-center justify-between">
                  <div className="pr-4 tracking-wide w-full">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex -space-x-2">
                        <img
                          src="https://picsum.photos/seed/u1/30/30"
                          className="w-5 h-5 rounded-full border-2 border-slate-100 dark:border-slate-800"
                          alt="user"
                          referrerPolicy="no-referrer"
                        />
                        <img
                          src="https://picsum.photos/seed/u2/30/30"
                          className="w-5 h-5 rounded-full border-2 border-slate-100 dark:border-slate-800"
                          alt="user"
                          referrerPolicy="no-referrer"
                        />
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between">
                <div className="pr-4 tracking-wide flex-1">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-bold text-lg text-slate-900 dark:text-white group-hover:text-brand transition-colors tracking-tight">
                      Solve DPPs
                    </h3>
                  </div>
                  <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed font-bold tracking-tight mb-1 text-slate-900 dark:text-white">
                    Structured Daily Practice
                  </p>
                  <p className="text-[11px] text-slate-600 dark:text-slate-300 mb-3">
                    700+ curated problems by expert educators.
                  </p>
                </div>
            ...
            {(chapters[activeTab as keyof typeof chapters] || []).map(
              (chapter, i) => (
                ...
                >
                  ...
                  >
                    <div className="absolute top-0 right-0 w-32 h-32 bg-white/1 dark:bg-slate-900/10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2 group-hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors" />
        ...
        <section className="mt-8 space-y-8 pb-10">
          ...
          <div className="bg-slate-50/80 dark:bg-slate-800/80 p-5 rounded-3xl border border-slate-900/5 dark:border-white/5 relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-2 relative z-10">
              ...
              <button className="p-2 bg-white/5 dark:bg-slate-900/5 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800 transition-colors cursor-pointer active:scale-95 text-slate-600 dark:text-slate-300">
                <Share2 size={20} />
              </button>
            </div>
            ...
            <button className="w-full py-4 text-[15px] bg-white dark:bg-slate-700 text-slate-900 dark:text-white font-bold rounded-[14px] hover:bg-slate-100 dark:hover:bg-slate-600 transition-colors relative z-10 shadow-lg shadow-white/10 dark:shadow-none active:scale-[0.98]">
              Invite Friends
            </button>
          </div>
          ...
          <div className="text-center py-6">
              ...
              {[1, 2, 3, 4, 5].map((star) => (
                ...
                >
                  <Star
                    size={42}
                    className={
                      star === 5 ?"fill-transparent" :"fill-transparent"
                    }
                    strokeWidth={1.5}
                  />
                </button>
            ...
            <button className="text-[17px] font-bold text-slate-900 dark:text-white hover:text-slate-700 dark:hover:text-slate-700 dark:text-slate-200 transition-colors">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3.5">
              <a
                href="#"
                className="flex items-center gap-3.5 bg-slate-50 dark:bg-slate-800 p-4 rounded-xl border border-slate-900/5 dark:border-white/5 hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-700 transition-colors active:scale-[0.98]"
              >
