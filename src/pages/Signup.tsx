...
const Signup = () => {
  ...
  const { loginWithGoogle, loginWithGithub, signupWithEmail, loginAsDemo } = useUser();
      ...
      >
        ...
        <div className="mt-8">
          <div className="relative flex items-center justify-center mb-8">
            ...
            <span className="relative px-4 bg-white text-sm text-slate-400 font-medium">Or sign up with</span>
          </div>
