      ...
      <main className="px-6 space-y-6">
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="w-full bg-slate-800/50 border border-white/10 rounded-2xl p-4 flex flex-wrap gap-2 items-center focus-within:border-brand/50 transition-colors">
              {tags.map(tag => (
                <span key={tag} className="flex items-center gap-1 bg-brand/20 text-brand px-2 py-1 rounded-md text-xs font-bold">
                  {tag}
              ...
              <input
                ...
                className="bg-transparent text-white placeholder:text-slate-500 focus:outline-none flex-1 min-w-[120px] text-sm"
              />
            </div>
          </div>
          <div>
