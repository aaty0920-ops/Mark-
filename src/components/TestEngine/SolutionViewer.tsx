...
import { collection, query, where, orderBy, onSnapshot, doc, setDoc, updateDoc, increment, getDocs, deleteDoc, getDoc, addDoc } from 'firebase/firestore';
...
const SolutionViewer: React.FC<SolutionViewerProps> = ({ results, onBack }) => {
  ...
  const handleSaveToNotebook = () => {
    ...
    setSavedToNotebook(prev => ({ ...prev, [String(currentQuestion.id)]: true }));
  };
