...
const TestReport: React.FC<TestReportProps> = ({
  ...
  const mockTrendData = [
    ...
    {
      name:"Test 3",
      accuracy: Math.max(0, Math.min(100, accuracy - 5 + Math.random() * 10)),
    },
    {
      name:"Test 4",
      accuracy: Math.max(0, Math.min(100, accuracy - 2 + Math.random() * 5)),
    },
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 text-slate-900 dark:text-white pb-24">
      {/* Header */}
      <header className="px-6 pt-8 pb-4 sticky top-0 bg-white/8 dark:bg-slate-900/80 backdrop-blur-lg z-40">
      ...
      <main className="px-6 mt-6 space-y-6">
        ...
        >
          <div className="relative z-10">
            <div className="text-sm font-bold text-slate-900 dark:text-white/60 uppercase tracking-widest mb-2">
              Marks Obtained
            </div>
          ...
          <div className="absolute -right-10 -bottom-10 w-40 h-40 bg-white/1 dark:bg-slate-900/10 rounded-full blur-3xl" />
          <div className="absolute -left-10 -top-10 w-40 h-40 bg-white/1 dark:bg-slate-900/10 rounded-full blur-3xl" />
        </motion.div>
              ...
              >
                ...
                >
                  ...
                  <Tooltip
                    ...
                    formatter={(value: any) => [
                      `${Math.round(Number(value))}%`,"Accuracy",
                    ]}
                  />
                  <Line
                    type="monotone"
        ...
        <div className="bg-slate-50/40 dark:bg-slate-800/40 p-6 rounded-[2rem] border border-slate-900/5 dark:border-white/5">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="h-2.5 bg-slate-100 dark:bg-slate-700 rounded-full overflow-hidden">
                <div className="h-full bg-white dark:bg-slate-900 w-[10%] rounded-full" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3 pb-6">
          <motion.button
            ...
            className="w-full py-4 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white font-bold rounded-2xl flex items-center justify-center gap-3 border border-slate-900/5 dark:border-white/5 shadow-xl hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-700 transition"
          >
            <BookOpen size={20} />
            View Solutions
