...
export const formulasData: Record<string, SubjectData> = {
  Physics: {
    chapters: {"Current Electricity": {
            ...
            cards: [
              {
                ...
                important_notes: ["Denoted by the letter 'I'","1 Ampere = 1 Coulomb / 1 Second",
                ],
              ...
              },
              {
                ...
                important_notes: ["Current is same across varying cross-sections in steady state.","Follows Kirchhoff's junction law (conservation of charge).",
                ],
              ...
              },
              {
                ...
                variables: {
                  j:"Current Density",
                  i:"Current",
                  S:"Area","\\theta":"Angle between area vector and current",
                },
                units: {
                  j:"Amperes/metre² (A/m²)",
                  i:"Amperes (A)",
                ...
                important_notes: ["Denoted by 'J'.","Vector quantity with direction same as current.","If i_A = i_B and S_A < S_B, then j_A > j_B.",
                ],
              ...
              },
              {
                ...
                variables: {"V_{rms}":"Root mean square velocity",
                  v_d:"Drift velocity",
                  i:"Current",
                  j:"Current density",
                ...
                important_notes: ["In the absence of external field, electrons move with random motion with V_{rms}.","Drift velocity is very small compared to V_{rms}.",
                ],
              ...
              },
              {
                ...
                variables: {"\\mu":"Mobility",
                  V_d:"Drift velocity",
                  E:"Electric field",
                  e:"Charge of electron","\\tau":"Relaxation time",
                  m:"Mass of electron",
                },
                units: {"\\mu":"cm² V⁻¹ s⁻¹ or m² V⁻¹ s⁻¹",
                  V_d:"m/s",
                  E:"V/m",
                },
                important_notes: ["Denoted by (\\mu).","Mobility of electrons is independent of 1) electric field 2) dimension of conductor.",
                ],
              ...
              },
              {
                ...
                important_notes: ["Here R is the proportionality constant and is the resistance offered by the conductor.","Graph of V vs I is a straight line with slope \\tan\\theta = R.",
                ],
            ...
            cards: [
              {
                ...
                important_notes: ["Ohm's law is not a universal law (non-ohmic devices exist)","V-I graph for ohmic conductors is a straight line passing through origin",
                ],
            ...
            cards: [
              {
                ...
                important_notes: ["Valid ONLY for constant acceleration","Vector quantities must be used with proper signs",
                ],
            ...
            cards: [
              {
                ...
                variables: {"\\vec{F}":"Net external force","\\vec{p}":"Momentum",
                  m:"Mass","\\vec{a}":"Acceleration",
                },
                units: {"\\vec{F}":"Newton (N)","\\vec{p}":"kg m/s",
                  m:"kg","\\vec{a}":"m/s^2",
                },
                important_notes: ["F = ma is valid only if mass is constant","It is a vector equation",
                ],
              ...
              },
              {
                ...
                variables: {
                  f_s:"Static friction",
                  f_k:"Kinetic friction","\\mu_s":"Coefficient of static friction","\\mu_k":"Coefficient of kinetic friction",
                  N:"Normal force",
                },
                units: {
                  f_s:"Newton (N)",
                ...
                important_notes: ["Static friction is self-adjusting up to a maximum value","Kinetic friction is usually less than maximum static friction",
                ],
      ...
      Semiconductors: {
        topics: {"Intrinsic Semiconductors": {
            total_cards: 2,
            cards: [
              {
                id:"PHYS-SEMI-01",
                ...
                important_notes: ["Valid for both intrinsic and extrinsic semiconductors in thermal equilibrium (Mass Action Law).",
                ],
              ...
              },
              {
                ...
                variables: {"\\sigma":"Conductivity",
                  e:"Elementary charge",
                  n_e:"Electron concentration",
                  n_h:"Hole concentration","\\mu_e":"Electron mobility","\\mu_h":"Hole mobility",
                },
                units: {"\\sigma":"S/m or (\\Omega \\cdot m)^{-1}","\\mu_e":"m^2/(V\\cdot s)","\\mu_h":"m^2/(V\\cdot s)",
                },
                important_notes: ["Electron mobility is generally higher than hole mobility.",
                ],
        ...
        topics: {"AC Voltage Applied to a Resistor": {
            total_cards: 2,
            cards: [
              {
                id:"PHYS-AC-01",
                ...
                variables: {"I_{rms}":"RMS Current",
                  I_0:"Peak Current",
                },
                units: {"I_{rms}":"Ampere (A)",
                  I_0:"Ampere (A)",
                },
                important_notes: ["Standard AC ammeters measure RMS values, not peak values.","Household voltage (e.g., 220V) is an RMS value.",
                ],
              ...
              },
              {
                ...
                variables: {"P_{avg}":"Average Power","V_{rms}":"RMS Voltage","I_{rms}":"RMS Current",
                  V_0:"Peak Voltage",
                  I_0:"Peak Current",
                },
                units: {"P_{avg}":"Watt (W)",
                },
                important_notes: ["In a purely resistive circuit, voltage and current are in phase.","Power factor (cos \\phi) is 1.",
                ],
            ...
            cards: [
              {
                ...
                important_notes: ["Moment of inertia depends on the choice of the axis of rotation.","For a system of particles, I = \\sum m_i r_i^2.",
                ],
              ...
              },
              {
                ...
                variables: {
                  I:"Moment of inertia about any axis","I_{cm}":"Moment of inertia about a parallel axis through CM",
                  M:"Total mass of the body",
                  d:"Perpendicular distance between the two axes",
                },
                units: {
                  I:"kg \\cdot m^2","I_{cm}":"kg \\cdot m^2",
                  M:"kg",
                  d:"m",
                },
                important_notes: ["Valid for any rigid body (1D, 2D, or 3D).","The two axes MUST be parallel, and one MUST pass through the center of mass.",
                ],
  ...
  Chemistry: {
    chapters: {"p Block Elements (Group 13 & 14)": {
        topics: {"General Properties": {
            total_cards: 1,
            cards: [
              {
                id:"CHEM-PBLK-01",
                ...
                variables: {},
                units: {},
                important_notes: ["Prominent in heavier p-block elements (Tl, Pb, Bi)","Caused by poor shielding of d and f electrons",
                ],
            ...
            cards: [
              {
                ...
                variables: {
                  E:"Cell potential","E^\\circ":"Standard cell potential",
                ...
                units: {
                  E:"Volts (V)","E^\\circ":"Volts (V)",
                  T:"Kelvin (K)",
                },
                important_notes: ["At 298K, RT/F = 0.0591 V","Formula simplifies to E = E° - (0.0591/n) log Q at 298K",
                ],
      ...
      Thermodynamics: {
            ...
            cards: [
              {
                ...
                formula:"\\Delta U = q + w",
                variables: {"\\Delta U":"Change in internal energy",
                  q:"Heat added to the system",
                  w:"Work done on the system",
                },
                units: {"\\Delta U":"Joule (J)",
                  q:"Joule (J)",
                  w:"Joule (J)",
                },
                important_notes: ["Sign convention is crucial: q is positive if heat is added TO the system","w is positive if work is done ON the system (IUPAC convention)",
                ],
            ...
            cards: [
              {
                ...
                variables: {
                  k:"Rate constant",
                  t:"Time","[A]_0":"Initial concentration","[A]":"Concentration at time t",
                },
                units: {
                  k:"s^{-1}",
                  t:"s",
                },
                important_notes: ["Half-life is independent of initial concentration.","Radioactive decay follows first-order kinetics.",
                ],
              ...
              },
              {
                ...
                important_notes: ["A plot of ln(k) vs 1/T gives a straight line with slope -E_a/R.",
                ],
        ...
        topics: {"General Organic Chemistry": {
            total_cards: 1,
            cards: [
              {
                id:"CHEM-ORG-01",
                ...
                variables: {},
                units: {},
                important_notes: ["It is a permanent effect.","It operates through sigma bonds.","It decreases with distance.",
                ],
            ...
            cards: [
              {
                ...
                units: {},
                important_notes: ["Helps in predicting hybridization and shape.",
                ],
            ...
            cards: [
              {
                ...
                units: {},
                important_notes: ["x MUST be in radians, not degrees","Can be proven using Squeeze Theorem",
                ],
              ...
              },
              {
                ...
                units: {},
                important_notes: ["Can be derived using L'Hopital's rule or Taylor series expansion",
                ],
            ...
            cards: [
              {
                ...
                units: {},
                important_notes: ["Use ILATE rule to choose u: Inverse trig, Logarithmic, Algebraic, Trigonometric, Exponential",
                ],
            ...
            cards: [
              {
                ...
                variables: {
                  d:"Distance","(x_1, y_1)":"Coordinates of first point","(x_2, y_2)":"Coordinates of second point",
                },
                units: {},
                important_notes: ["Derived from the Pythagorean theorem."],
              ...
              },
              {
                ...
                variables: {
                  d:"Perpendicular distance","(x_1, y_1)":"Coordinates of the point","a, b, c":"Coefficients of line equation ax + by + c = 0",
                },
                units: {},
                important_notes: ["The absolute value is necessary because distance cannot be negative.",
                ],
            ...
            cards: [
              {
                ...
                variables: {
                  x:"Roots of the equation","a, b, c":"Coefficients of the quadratic equation",
                },
                units: {},
                important_notes: ["The term b^2 - 4ac is called the discriminant (D).","If D > 0, roots are real and distinct.","If D = 0, roots are real and equal.","If D < 0, roots are complex conjugates.",
                ],
            ...
            cards: [
              {
                ...
                variables: {},
                units: {},
                important_notes: ["Located outside the abdominal cavity in the scrotum.","Scrotum helps maintain temperature 2-2.5°C lower than internal body temp.",
                ],
            ...
            cards: [
              {
                ...
                variables: {},
                units: {},
                important_notes: ["Also known as the First Law of Inheritance.","Universally applicable without exceptions.",
                ],
